...
export default function FileItem( {id, name, size, deleteFile, previewFile} ) {
  return ( 
    <div className='mb-2.5 max-w-xs rounded overflow-hidden shadow-fileBs bg-orange-500 opacity-100 hover:opacity-80 cursor-pointer' onClick={previewFile}> 
        <div className='flex flex-col'>
            ...
            <p className="p-1 pr-3 self-end text-gray-900">{size} KB</p>
        </div>
    </div>
  )
}
